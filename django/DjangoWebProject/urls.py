...
from app.views import ChangeAvatar,ProductLikesDelete,UserProfile,DeleteUser,NotFound,SendLetter,ProductAvailableCount,LoginView,ProductsView,SignUpView,ProductView,ProductLikesShow,ProductSort,ProductInfo,ProductInfoBrands,ProductLikes
